...
Select nombre pais from pinacotecas WHERE ID_PINACOTECA like 'MUBAS';
...
Select nombre, ciudad from mecenas where concat(pais = 'italia');
...
Select nombre, fecha_aparicion from escuelas where pais = 'España' or pais = 'Italia';
